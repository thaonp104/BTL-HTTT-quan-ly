...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Online Handling Employee</title>
    ...
    <div class="slimscroll-menu">
        ...
        <div id="sidebar-menu">
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="/onlinehandlingemployee/managebill" class="waves-effect">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width: 1%"><a href="/onlinehandlingemployee/managebill/detail/{id}" class="btn btn-primary">Detail</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
