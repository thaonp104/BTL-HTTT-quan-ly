...
<div class="defaultContent BlockContent">
  <ul class="ProductList First">
    <?php
      ...
      $arr = DB::table('products')->where('brandsid',8)->orderBy('id','desc')->limit(3)->get();
      foreach ($arr as $rows) {
     ?>
    <li class="Odd">
      ...
      <div class="ProductPrice">
        <div class="special_price">
            <span class="price"> <em> <?php echo number_format($rows->pricenew) ?> ₫</em> </span>
        </div>
      </div>
  ...
  <div class="ViewMore"> <a href="{{ URL::asset('customer/products/category/8') }}">Xem thêm</a> </div>
  <div class="Clear"></div>
</div>
