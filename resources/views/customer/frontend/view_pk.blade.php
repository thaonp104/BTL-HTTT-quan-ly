<div class="defaultTitle TitleContent"> <span>Phụ kiện</span> </div>
<div class="defaultContent BlockContent">
  <ul class="ProductList First">
    <?php
      use Illuminate\Support\Facades\DB;
      $arr = DB::table('product')->where('category_product_id',11)->orderBy('product_id','desc')->limit(3)->get();
      foreach ($arr as $rows) {
     ?>
    <li class="Odd">
      ...
      <div class="ProductPrice">
        <div class="special_price">
            <span class="price"> <em> <?php echo number_format($rows->c_pricenew) ?> ₫</em> </span>
        </div>
      </div>
  ...
  <div class="ViewMore"> <a href="{{ URL::asset('customer/products/category/10') }}">Xem thêm</a> </div>
  <div class="Clear"></div>
</div>
