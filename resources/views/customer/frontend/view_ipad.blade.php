<div class="defaultTitle TitleContent"> <span>ipad</span> </div>
<div class="defaultContent BlockContent">
  <ul class="ProductList First">
    <?php
      use Illuminate\Support\Facades\DB;
      $arr = DB::table('product')->where('category_product_id',4)->orderBy('product_id','desc')->limit(3)->get();
      foreach ($arr as $rows) {
     ?>
    <li class="Odd">
  ...
  <div class="ViewMore"> <a href="{{ URL::asset('customer/products/category/4') }}">Xem thêm</a> </div>
  <div class="Clear"></div>
</div>
