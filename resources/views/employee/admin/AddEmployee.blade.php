            ...
            <form action="/admin/manageemployee/store" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="role" required class="form-control">
                        ...
                        <option value="storemanager" @if($role == 'storemanager') selected @endif>Store Manager</option>
                        <option value="seniormanager" @if($role == 'seniormanager') selected @endif>Senior Manager</option>
                        <option value="telesale" @if($role == 'telesale') selected @endif>Telesale</option>
                ...
                <div class="form-group">
                    ...
                    <select name="branch" required class="form-control">
                        @foreach($branches as $b)
                            <option value="{{ $b->id }}" @if($branch == $b->id) selected @endif>{{ $b->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
